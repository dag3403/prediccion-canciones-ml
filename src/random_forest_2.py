...
if __name__ == "__main__":
    ...
    # 6. Construcción del Pipeline de Modelado con Texto
    ...
    # Incorporamos class_weight='balanced' para mitigar el desbalance sin eliminar artistas
    ...
    # 7. Optimización de hiperparámetros con 10-Fold CV (Optimizando f1_macro)
    ...
    # 8. Evaluación y métricas en el conjunto de test
    ...
    # --- 9. GUARDAR RESULTADOS EN JSON DENTRO DE LA CARPETA data ---
    resultados_dict = {
    ...
    json_path = "models/resultados_modelo_random_forest_2.json"
    ...
    print("\n================ MÉTRICAS FINALES EN TEST (MIXTO + BALANCED) ================")
