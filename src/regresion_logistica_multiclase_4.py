...
preprocessor = ColumnTransformer(transformers=[('num', StandardScaler(), numeric_features), ('text', text_transformer, 'text_combined')], remainder='drop')
...
with open("models/resultados_lr_4.json", "w", encoding="utf-8") as f:
    json.dump(resultados_dict, f, indent=4, ensure_ascii=False)
print("Modelo Logístico 4 completado y guardado.")