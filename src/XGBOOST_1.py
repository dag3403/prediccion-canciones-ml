...
param_grid = {'classifier__n_estimators': [100, 200], 'classifier__max_depth': [3, 6], 'classifier__learning_rate': [0.05, 0.1]}
...
with open("models/resultados_xgboost_1.json", "w", encoding="utf-8") as f:
    json.dump(resultados_dict, f, indent=4, ensure_ascii=False)
print("Pipeline XGBoost Sin Balancear completado.")