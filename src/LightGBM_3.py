...
lgb_clf = LGBMClassifier(objective='multiclass', random_state=42, n_jobs=-1, verbose=-1)
...
with open("models/resultados_lightgbm_3.json", "w", encoding="utf-8") as f:
    json.dump(resultados_dict, f, indent=4, ensure_ascii=False)
print("Pipeline LightGBM SMOTETomek Mediana completado.")