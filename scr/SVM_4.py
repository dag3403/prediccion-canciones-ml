...
svc_clf = SVC(probability=True, class_weight=weights_q75, random_state=42)
...
resultados_dict = {
    "estrategia": "SVM Caso 4: Balanceo al Cuantil 75",
...
with open("models/resultados_svm_4.json", "w", encoding="utf-8") as f:
    json.dump(resultados_dict, f, indent=4, ensure_ascii=False)
print("SVM Caso 4 (Balanceo al Cuantil 75) completado y guardado.")