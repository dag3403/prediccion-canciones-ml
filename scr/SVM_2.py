...
resultados_dict = {
    "estrategia": "SVM Caso 2: Penalización de errores",
...
with open("models/resultados_svm_2.json", "w", encoding="utf-8") as f:
    json.dump(resultados_dict, f, indent=4, ensure_ascii=False)
print("SVM Caso 2 (Penalizado) completado y guardado.")